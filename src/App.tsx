...
const statusLabel: Record<Connection, string> = { unchecked: 'Not checked', checking: 'Connecting…', online: 'Reachable', offline: 'Not reachable' };
